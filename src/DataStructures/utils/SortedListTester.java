...
public class SortedListTester {
	...
	public static void main(String[] args) {
		...
		System.out.println("-----------------------");
		SortedList<String> sortedList2 = new SortedLinkedList<String>();
		
		sortedList2.add("Pedro");
		sortedList2.add("Maria");
		sortedList2.add("Juan");
		sortedList2.add("Juano");
		sortedList2.add("Juana");
		sortedList2.add("Cal");
		sortedList2.add("Yone");
		sortedList2.add("Kentuky");
		
		System.out.println("First Index: " + sortedList2.firstIndex("Maria") + " With get: " + sortedList2.get(sortedList2.firstIndex("Maria")));	
		
		//System.out.println("First Index: " + sortedList2.firstIndex("NO") + " With get: " + sortedList2.get(sortedList2.firstIndex("NO")));	
		
		System.out.println("First Index: " + sortedList2.firstIndex("Kentuky") + " With get: " + sortedList2.get(sortedList2.firstIndex("Kentuky")));	
		
		sortedList2.removeIndex(sortedList2.size()-1);
		//System.out.println(sortedList2.firstIndex("Kentuky"));
		//sortedList2.removeIndex(sortedList2.firstIndex("Kentuky"));
		System.out.println(sortedList2.firstIndex("Kentuky"));
